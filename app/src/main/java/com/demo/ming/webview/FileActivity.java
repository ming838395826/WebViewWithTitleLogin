...
//            TLog.d(TAG, "文件path:" + path);
    ...
    private void getFilePathAndShowFile(SuperFileView2 mSuperFileView2) {
        ...
        if (getFilePath().contains("http")) {//网络地址要先下载
            progressBarNormal.setVisibility(View.VISIBLE);
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    while ((len = is.read(buf)) != -1) {
                        ...
                        progressBarNormal.setProgress(progress);
                    ...
                    progressBarNormal.setVisibility(View.GONE);
                } catch (Exception e) {
                    TLog.d(TAG, "文件下载异常 = " + Log.getStackTraceString(e));
                } finally {
                    try {
                        if (is != null)
                            is.close();
